...
class CollectedBlockStructureTestCase(TestCase):
    ...
    def test_feature_enabled_returns_cached_structure(self):
        ...
        # Create mock API module with get_course_in_cache function
        mock_api = mock.MagicMock()
        mock_api.get_course_in_cache = mock.MagicMock(return_value=mock_block_structure)
        ...
        with mock.patch.dict('sys.modules', {
            ...
            result = compat.get_collected_block_structure(course_key)
            mock_api.get_course_in_cache.assert_called_once_with(course_key)
