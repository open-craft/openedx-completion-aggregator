...
# Performance tuning settings (defaults for backward compatibility)
COMPLETION_AGGREGATOR_UPDATER_CACHE_TIMEOUT = 600  # 10 minutes
COMPLETION_AGGREGATOR_USE_COLLECTED_BLOCK_STRUCTURE = False
